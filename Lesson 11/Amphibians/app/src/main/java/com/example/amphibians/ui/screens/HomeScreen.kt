...
fun AmphibiansListScreenPreview() {
    AmphibiansTheme {
        val mockData = List(10) {
            Amphibian(
            "Nombre del anfibio - $it",
            "$it",
            "Descripción del anfibio $it. Este anfibio es conocido por habitar en los humedales y bosques tropicales de América Central. Es de tamaño medio y presenta una coloración verde brillante para camuflarse entre la vegetación. Su dieta se compone principalmente de insectos y pequeños reptiles. Se distingue por su llamativo canto durante la temporada de lluvias.",
            imgSrc = ""
        )
